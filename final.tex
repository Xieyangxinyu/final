...
\begin{lem}[\cite{berman1962equally};\cite{arias2012correlation}, Lemma 2.1]
  \label{lemqf}
...
\begin{prop}[\cite{berman1962equally};\cite{arias2012correlation}, Proposition 2.1]
...
\begin{prop}[\cite{berman1962equally};\cite{arias2012correlation}, Theorem 2.1]
  \label{thmlower}
